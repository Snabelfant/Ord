...
public class YesNoCancel {
    private final static int YES = 0x01;
    private final static int NO = 0x02;
    private final static int CANCEL = 0x04;
    ...
    void show1(Context context, String title, String message, final Action yesAction, final Action noAction, final Action cancelAction) {
